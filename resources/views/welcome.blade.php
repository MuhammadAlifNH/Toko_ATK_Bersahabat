            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="jumbotron">
                            <h1 class="display-4">Selamat Datang di Project Akhir Pemrograman Web Lanjut</h1>
                            <h1 class="display-4">Semester 4</h1>
                            <p class="lead">Pada project ini kami membuat website Toko ATK Bersahabat.</p>
                            <hr class="my-4">
                            <p>2024 || UNISNU Jepara.</p>
                        </div>
                    </div>
                </div>
